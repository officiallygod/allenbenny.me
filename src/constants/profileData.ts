...
export const profileData: Record<Language, ProfileData> = {
  ...
  de: {
    ...
    technologies: [
      { name: 'PHP', category: 'Sprache' },
      { name: 'JavaScript', category: 'Sprache' },
      { name: 'TypeScript', category: 'Sprache' },
      { name: 'Java', category: 'Sprache' },
      { name: 'C', category: 'Sprache' },
      { name: 'C++', category: 'Sprache' },
      { name: 'Dart', category: 'Sprache' },
      { name: 'Python', category: 'Sprache' },
      { name: 'SQL', category: 'Sprache' },
      { name: 'React', category: 'Framework' },
      { name: 'Node.js', category: 'Framework' },
      { name: 'Express.js', category: 'Framework' },
      { name: 'Django', category: 'Framework' },
